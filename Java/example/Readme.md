...
The `JavaApiExplorer` CLI tool is in the parent `Java/` directory. It reads `api-doc.json` from the classpath.
...
node ../../javascript/javascript-api-explorer.js --doc-path ./target/classes/ UserService
node ../../javascript/javascript-api-explorer.js --doc-path ./target/classes/ UserService.findUser
node ../../javascript/javascript-api-explorer.js --doc-path ./target/classes/ ProductService.createProduct
```
